    ...
    >
      ...
      <nav className="border-b-4 border-black bg-white px-6 py-4 sticky top-0 z-50 flex items-center justify-between">
        ...
        <button 
          ...
          className="flex items-center gap-3 cursor-pointer bg-transparent border-0 text-left p-0 focus:outline-none"
        >
        ...
        <div className="hidden md:flex items-center gap-8">
          <button 
            ...
            className={`font-mono text-xs font-bold uppercase tracking-widest text-black hover:underline hover:underline-offset-4 decoration-4 transition-all ${
              currentSubView === 'landing' ? '' : 'opacity-70 hover:opacity-100'
            }`}
          >
            FEATURES
          </button>
          ...
          <button 
            ...
            className={`font-mono text-xs font-bold uppercase tracking-widest text-black hover:underline hover:underline-offset-4 decoration-4 transition-all ${
              currentSubView === 'events' ? 'underline underline-offset-4 decoration-4 font-black' : 'opacity-70 hover:opacity-100'
            }`}
          >
            EVENTS
          </button>
