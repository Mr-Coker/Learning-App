...
export function AdminDashboard({ userEmail, onLogout }: AdminDashboardProps) {
  ...
  return (
    <div className="flex-1 flex flex-col p-6 md:p-10 bg-white overflow-y-auto select-none">
      {/* Admin Title Banner */}
      <div className="border-4 border-black bg-black text-white p-6 shadow-[4px_4px_0_0_rgba(255,216,51,1)] mb-8 flex justify-between items-center">
        <div>
          <h1 className="font-serif text-3xl font-black uppercase tracking-tighter text-[#FFD833]">
            SYSTEM_ADMIN // SECURITY_PORTAL
          </h1>
      ...
      {/* Main Roster, Financials, and Dispatch grid */}
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        
        {/* Left 2 Cols: Student roster & Financials */}
        <div className="xl:col-span-2 space-y-10">
          ...
          <div>
            ...
            <div className="border-4 border-black bg-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] overflow-auto max-h-[300px]">
